package s11.product_management.service.product_service;


import s11.product_management.model.product.Product;
import s11.product_management.repository.IProductRepository;
import s11.product_management.repository.product_repository.ProductRepository;
import s11.product_management.service.IProductService;
...
public class ProductService implements IProductService {
    ...
    public void searchProduct() {
        ...
        if (product == null) {
            System.out.println("Không có sản phẩm tên: " + name);
        } else {
            System.out.println(product);
        }
    }
    ...
    public void editProduct() {
        ...
        if (product == null) {
            ...
            if (choice == 1) {
                ...
                System.out.println("Bạn đã thay đổi sản phẩm!!!");
            }
