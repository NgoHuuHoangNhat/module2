...
public class Room extends Facility {
    ...
    public Room(String serviceCode, String serviceName, float area, float rentalCosts, int maxNumberOfPeople, String rentalType) {
        super(serviceCode, serviceName, area, rentalCosts, maxNumberOfPeople, rentalType);
    }

    public Room(String serviceCode, String serviceName, float area, float rentalCosts,
