...
//                String rentalEndDay, String customerId, String facilityId
        bookingSet.add(new Booking("BK-0001", "21-12-2021", "30-12-2021", "15-01-2022",
                customerList.get(0).getId(), villaList.get(0).getServiceCode()));

        bookingSet.add(new Booking("BK-0002", "04-12-2021", "05-12-2021", "30-12-2021",
                customerList.get(0).getId(), houseList.get(0).getServiceCode()));

        bookingSet.add(new Booking("BK-0003", "15-12-2021", "05-01-2022", "30-01-2022",
